...
{{#success build.status}}
  ...
  :new: {{build.message}}
  :debian: The new `matrixio-openocd_%%DISTRIBUTION%%-%%CODENAME%%-%%PKG_VER%%-%%COMPONENT%%_armhf.deb` was published to `apt.matrix.one/%%DISTRIBUTION%% %%CODENAME%% %%COMPONENT%%`
{{else}}
  ...
  :debian: The package `matrixio-openocd_%%DISTRIBUTION%%-%%CODENAME%%-%%PKG_VER%%-%%COMPONENT%%_armhf.deb` failed to build.
{{/success}}
